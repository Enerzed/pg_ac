...
/*  Initializing automaton storage  */
SELECT ac_init();

/*  Building ASCII automata  */
...
/*  Search tests with tsquery (automaton 1)  */
...
/*  Ranking and ac_match tests (automata 5, 6)  */
...
/* ac_match tests with Cyrillic text */
SELECT ac_match(7, 'привет пока мир') AS matches_russian;   -- {1,3,2}

/* Search tests with diacritics */
...
/* ac_match tests with diacritics */
